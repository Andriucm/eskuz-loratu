...
<template>
    <Sheet>
        ...
        <SheetContent side="right" class="sheet-content w-full bg-[var(--color-fondo)]  p-6">
            <SheetHeader>
            ...
            <div class="menu-container">
                ...
                <div class="menu-item" @click="goToInstagram">
                ...
                <SheetClose as-child>
                    <div class="menu-item" @click="goToAddJewel">
                        <i class="fa-solid fa-plus"></i> {{ authStore.isLoggedIn ? $t('menu.addJewel') :
                        $t('menu.login') }}
                    </div>
                </SheetClose>
...
.menu-item select:focus {
    ...
    box-shadow: 0 0 0 2px var(--color-actions);
    outline: none;
}
...
.menu-item select:focus-visible {
    outline: none;
}
</style>